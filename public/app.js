...
searchForm.addEventListener("submit", async (e) => {
  ...
  console.log("DEBUG: Selected Manufacturer:", selectedManufacturer || "(All)");
  ...
  try {
    ...
    const requestBody = {
        ...
        manufacturer: selectedManufacturer // Include selected manufacturer (backend handles empty string)
    };
...
clearBtn.addEventListener("click", () => {
  ...
  manufacturerSelect.value = ""; // Reset manufacturer dropdown
